...
*/
$( function() {
        var endDate = "Nov  27, 2022 11:00:00";
        ...
        $('.countdown.styled').countdown({
          ...
          render: function(data) {
            $(this.el).html("<div class='p-4'>" + this.leadingZeros(data.days, 2) + " <span>days</span></div><div class='p-4'>" + this.leadingZeros(data.hours, 2) + " <span>hrs</span></div><div class='p-4'>" + this.leadingZeros(data.min, 2) + " <span>min</span></div><div class='p-4'>" + this.leadingZeros(data.sec, 2) + " <span>sec</span></div>");
          }
        });
